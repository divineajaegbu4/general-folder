...
const bigNumber = BigInt("22222222222222222222222222222222222222222222222222222")
...
console.log(`increase the student count by ${String(addAStudent(increaseStudent))}, and typeof ${typeof(addAStudent(increaseStudent))}`);
...
console.log("---------------------------------------------Double Equality Tests")
